...
kraken2-build --download-taxonomy --db kraken2-microbial-soup-giardia --use-ftp
kraken2-build --download-library archaea --db kraken2-microbial-soup-giardia --use-ftp
kraken2-build --download-library bacteria --db kraken2-microbial-soup-giardia --use-ftp
kraken2-build --download-library viral --db kraken2-microbial-soup-giardia --use-ftp
